...
const faqs: FAQItem[] = [
  {
    question: "Do I need technical skills to set up an election?",
    answer: "Not at all. Voterix is designed to be simple and intuitive — anyone can launch an election in minutes."
  },
  {
    question: "How are voters verified?",
    answer: "We use multi-factor authentication and unique voter IDs to ensure that every vote is cast by a legitimate, verified participant."
  },
  {
    question: "Can I monitor results in real time?",
    answer: "Yes! Our real-time dashboard allows you to track voter turnout and live results as they come in, with full audit transparency."
  },
  {
    question: "How secure is the platform?",
    answer: "Voterix uses end-to-end encryption and blockchain-inspired audit trails to ensure your election is tamper-proof and secure."
  }
];
        ...
        <div className="w-full max-w-[1152px] flex flex-col gap-5 md:gap-[22px]">
          {faqs.map((faq, index) => {
            ...
            return (
              <div 
                key={index}
                className={`w-full transition-all duration-300 rounded-[22px] border ${
                  isOpen 
              ...
              >
                ...
                >
                  ...
                  {/* Toggle Button */}
                  <div 
                    className={`shrink-0 w-[clamp(28px,3vw,36px)] h-[clamp(28px,3vw,36px)] rounded-full flex items-center justify-center transition-all duration-300 shadow-md ${
                      isOpen 
