    ...
    <div className="max-w-[1200px] mx-auto space-y-6">
       <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
             {view === "voters" && (
                <button onClick={() => setView("batches")} className="w-10 h-10 flex items-center justify-center bg-white border border-gray-200 rounded-xl text-gray-500 hover:bg-gray-50 transition-colors">
                   <ChevronLeft size={20} />
                </button>
             )}
             <div>
          ...
          <div className="flex items-center gap-3">
             ...
             {view === "voters" && (
                <button onClick={() => setIsAddModalOpen(true)} className="h-12 px-6 bg-[#405189] text-white rounded-2xl font-bold flex items-center gap-2 shadow-lg shadow-[#405189]/10 hover:opacity-95 transition-all">
       ...
       <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm overflow-hidden min-h-[500px]">
          {isLoading ? (
             ...
             <div className="p-8">
                {batches.length === 0 ? (
                   <div className="h-[400px] flex flex-col items-center justify-center text-center max-w-[400px] mx-auto">
