       ...
       <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
             ...
             <div>
                ...
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest flex items-center gap-2">
                   ...
                   {electionSummary && (
                      <span className="inline-flex px-2 py-0.5 bg-green-50 text-green-600 rounded text-[10px]">
          ...
          <div className="flex items-center gap-3">
             ...
             <button 
                ...
                className="h-12 px-6 bg-[#243160] text-white rounded-2xl font-bold flex items-center gap-2 shadow-lg shadow-[#243160]/10 hover:opacity-95 transition-all"
             >
                <Plus size={18} /> Generate PINs
             </button>
             <button onClick={handleRefresh} className="h-12 w-12 flex items-center justify-center bg-white border border-gray-200 rounded-2xl text-gray-500 hover:text-[#405189] transition-all active:rotate-180">
                <RefreshCw size={20} />
             </button>
          </div>
       </div>
